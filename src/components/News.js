...
export class News extends Component {
  ...
  async componentDidMount(){
   console.log("cdm")
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=a472465cf0ab48bd9c896feb59d00e82&page=1&pageSize=${this.props.pageSize}`;
 ...
 handlePreviousClick= async()=>{
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=a472465cf0ab48bd9c896feb59d00e82&page=
